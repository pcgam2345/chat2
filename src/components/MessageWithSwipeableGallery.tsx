...
import { SwipeablePhotoGallery } from "./SwipeablePhotoGallery";
...
interface MessageWithSwipeableGalleryProps {
  content: string;
  photos: PhotoCard[];
...
export const MessageWithSwipeableGallery: React.FC<MessageWithSwipeableGalleryProps> = ({
  content,
  photos,
  onTryNow,
  showAvatar = true,
  ...
  return (
    <div className="inline-flex items-start gap-3">
      ...
      <div className="flex flex-col gap-3 max-w-[280px]">
        ...
        <SwipeablePhotoGallery photos={photos} onTryNow={onTryNow} />
      </div>
    </div>
  );
};